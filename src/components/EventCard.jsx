...
const EventCard = () => {
  return (
    <>
      <div className="flex items-center gap-3 scroll-y-auto">
        <div className="pt-4 pb-4 pl-4">
          <div className="h-[65px] w-[65px] rounded-lg border-[1px] border-brand border-dashed overflow-hidden flex items-center justify-center">
            {/* <div className="bg-[#e63757] text-white flex items-center justify-center text-[13px] p-[2px] poppins-bold font-bold">
              Jan
            </div> */}
            <h3 className="-rotate-12 text-[35px] text-brand flex items-center justify-center poppins-bold">
              E
            </h3>
          </div>
        </div>
